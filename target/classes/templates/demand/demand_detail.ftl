...
<html>
 ...
 <hr>
 收货凭证：<a href="javascript:void(0);" id="viewarrivalPics" class="layui-btn layui-btn-mini" >点击查看</a>
  </div>
</fieldset>
  ...
  <#list commentList as comment>
    <tr>
      ...
      <td>
         <#list comment.picArray as img>
           <img src="${img}" onclick="viewImg($(this))"/>
         </#list>
      </td>
    </tr>
 </#list>   
...
<script>
		...
		//收获凭证
		var arrivalPicturesPic = new Object();
		arrivalPicturesPic.title="收货凭证"
		arrivalPicturesPic.id = "5"
		arrivalPicturesPic.start=0
		var arrF = new Array();
		var arrivalPicturesStr = ${(demandExt.arrivalPictures)!'[]'};
		for(var i=0;i<contractStr.length;i++){
		    var obj = new Object();
		    obj.alt='';
		    obj.pid=i;
		    obj.src=arrivalPicturesStr[i];
		    obj.thumb='';
		    arrF[i]=obj;
		}
		arrivalPicturesPic.data = arrF;
		...
		layui.use(['element','layer'], function(){
		  ...
		  $('#viewarrivalPics').on('click',function(){
		     layer.photos({
		         photos: arrivalPicturesPic 
		         ,anim: 5 
		  });
		  });
